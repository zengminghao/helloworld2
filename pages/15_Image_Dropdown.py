...
def image_gen() -> None:
    ...
    animal = col2.selectbox("Choose animal", ["duck", "hedgehog", "cat", "panda"])
    action = col2.selectbox("Choose action", ["sleeping", "jumping", "flying"])
    prompt = "a " + action + " " + animal

    col1.write("Your choice is: " + prompt)
